...
**החזון (החלטת בעלת המוצר, 09.07.2026):** VaadyGo אינה מוגבלת לוועדי הורים בגנים/בתי ספר. זו פלטפורמה גנרית לניהול גבייה, חברים ותקציב עבור **כל ארגון** שיש בו אנשים/יחידות וכסף לגבות — ועד בית, משרד, מחלקה בבית חולים, בנק, עמותה וכו'. **הגן הוא מקרה השימוש הראשון (Vertical #1), לא ההגדרה של המערכת.**
