...
- **⛔ שאלה לבעלת המוצר:** באפיון (UI_SPEC ס' 12) יש "ספקים מומלצים" עם דוגמה "מתנות בלב❓" — לא ברור אם זו רשימת המלצות קבועה של VaadyGo או סתם דוגמה. כרגע מימשתי שהספקים הם אלה שהמשתמשת מוסיפה בעצמה. אם רוצים רשימת המלצות מובנית — צריך להגדיר מאיפה היא מגיעה.
