...
namespace ParentCommitteeAPI.DTOs
{
    ...
    */
    ...
    public class VendorResponseDto
    {
        ...
        /*
          מסלול פרו לספק — פותח את פיצ'רי הפרו. **פעיל בפועל**: נרכש או פתוח
          במסגרת המבצע (פרו חינם לכל הספקים עד 1.10.2026).
        */
        public bool IsPro { get; set; }

        /*
          פרו **בתשלום** (או פתיחה ידנית של המנהלת) — להבדיל מהמבצע.

          נחוץ כי IsPro לבדו כבר לא עונה על "מי משלם לי": בזמן המבצע הוא true
          אצל כולם. הכפתור במסך המנהלת נשען על זה, אחרת הוא היה מציג "סגור
          מסלול פרו" לכל ספק — כולל מי שמעולם לא רכש.
        */
        public bool IsProPurchased { get; set; }

        /* הפרו פתוח כרגע ללא עלות (מבצע) ולא בתשלום — מפעיל את הבאנר לספק. */
        public bool IsTrial { get; set; }

        /* מתי הפרו החינמי נגמר. אותו מקור שקובע גם את הנעילה בפועל. */
