namespace ParentCommitteeAPI.Models
{
    ...
    */
    public class Group
    {
        ...
        // קבוצות שנמחקו אך נשמרות למעקב (מחיקה רכה) — שמות מופרדים בפסיקים. קבוצה
        // שגבו/הוציאו ממנה כסף אינה נמחקת לגמרי; היא עוברת לכאן, נשארת בפילוח
        // "גבייה לפי קבוצות" עם תווית "נמחקה", והתשלומים/ההוצאות שלה נשמרים.
        public string ArchivedSubgroups { get; set; } = string.Empty;
