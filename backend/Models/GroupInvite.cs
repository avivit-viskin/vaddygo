namespace ParentCommitteeAPI.Models
{
    ...
    */
    public class GroupInvite
    {
        ...
        // מוצגות ברשימת ה"גישות" כ"אושר" (במקום להיעלם).
        public bool Used { get; set; }

        // מי הצטרף עם ההזמנה (UserId) — מקשר את ההזמנה לחבר הצוות שנוצר, כדי
        // שברשימת ה"גישות" נוכל להציג את השם שהוזן + לנהל את החבר (הרשאה/הסרה).
