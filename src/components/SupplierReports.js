  ...
  return (
    ...
    >
      ...
      */}
      ...
      {/* מי פנה אליכם — שם וטלפון של כל פנייה (פרו בלבד). אותם נתונים של
          תיבת הפניות, כאן כרשימת מעקב בתוך הדוח. אין מייל לפונה — נשמרים
          שם וטלפון בלבד. */}
      {isPro && Array.isArray(leads) && leads.length > 0 && (
        <div style={{ marginBottom: 16 }}>
          <h4 style={{ margin: "0 0 10px", fontSize: "var(--font-size-base)" }}>
            מי פנה אליכם
          </h4>
