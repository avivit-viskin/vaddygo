    ...
    <div className="ai-page">
      <Card>
        ...
        <form onSubmit={handleSubmit} className="ai-form">
          ...
          />
          {/*
            הערת הפרטיות הייתה עד כה **הערה בקוד בלבד** — המשתמשת מעולם לא
            ראתה אותה. המערכת אכן אינה שולחת שמות מעצמה, אבל היא אינה יכולה
            למנוע ממי שמקלידה לכתוב "תנסחי הודעה לאמא של נועם". השאלה נשלחת
            לשירות חיצוני, ולכן ההנחיה חייבת להיות מול העיניים ברגע ההקלדה.
          */}
          <p className="ai-form__privacy">
            העוזרת היא שירות חיצוני — כדאי לא לכתוב שמות של ילדים או הורים,
            טלפונים או כתובות. אפשר לכתוב "הודעה להורים" במקום שם.
          </p>
